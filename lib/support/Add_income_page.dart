...
// //       body: const Center(child: Text("Add Income Page")),
// //     );
// //   }
// // }
// import 'package:flutter/material.dart';
// import 'package:cloud_firestore/cloud_firestore.dart'; // ນຳໃຊ້ Firestore
// import 'package:firebase_auth/firebase_auth.dart'; // ນຳໃຊ້ Auth ເພື່ອເອົາ userId
...
//   // ປະກາດ Controller ສຳລັບຊ່ອງປ້ອນຕົວເລກ
...
//         child: Column(
//           children: [
//             // 1. ສະແດງຮູບພາບ Logo ດ້ານເທິງ
//             // ໝາຍເຫດ: ຕ້ອງກວດສອບວ່າຊື່ໄຟລ໌ໃນ assets ຖືກຕ້ອງ (ເຊັ່ນ: logo.png)
//             Image.asset(
...
//                   if (user != null) {
//                     try {
//                       // ບັນທຶກລົງ Collection "income"
//                       await FirebaseFirestore.instance.collection("income").add({
//                         "amount": double.tryParse(amountController.text) ?? 0.0,
//                         "userId": user.uid,
//                         // ignore: equal_keys_in_mapບັນທືກມື້ທີເຫຼີອ ກຽວກັບປະຕິທິ
...
//                   backgroundColor: Colors.orange, // ໃຊ້ສີສົ້ມຕາມຮູບ UI
